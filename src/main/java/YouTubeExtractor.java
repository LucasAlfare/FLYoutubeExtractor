...
public abstract class YouTubeExtractor {
    ...
    private final String cacheDirPath = "/target/cache";
    ...
    public void extract(String youtubeLink) {
        this.doInBackground(youtubeLink);
    }
    ...
    protected HashMap<Integer, YtFile> doInBackground(String... params) {
        ...
        if (videoID != null) {
            try {
                ...
                System.err.println("Extraction failed " + e);
            }
        } else {
            //Log.e(LOG_TAG, "Wrong YouTube link format");
            System.err.println("Wrong YouTube link format");
        }
        return null;
    }
    ...
    private HashMap<Integer, YtFile> getStreamUrls() throws IOException, InterruptedException {
        ...
        if (mat.find()) {
            ...
            System.out.println("ytPlayerResponse was not found");
        }
        ...
        if (encSignatures.size() > 0) {
            ...
            if (signature == null) {
                ...
                for (int i = 0; i < encSignatures.size() && i < sigs.length; i++) {
                    ...
                    int key = (int) encSignatures.keySet().toArray()[i];
        ...
        this.onExtractionComplete(ytFiles, videoMeta);
    ...
    private boolean decipherSignature(final HashMap<Integer, String> encSignatures) throws IOException {
        ...
        if (decipherFunctionName == null || decipherFunctions == null) {
            ...
            //decipherViaWebView(encSignatures);
            System.out.println("We don't have webView to decipher...");
        }
        return true;
    }
    ...
    private void writeDeciperFunctToChache() {
        ...
        try {
            writer = new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(cacheFile.toPath()), "UTF-8"));
